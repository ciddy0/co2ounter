  ...
  return (
    <div className="flex flex-col gap-4 p-6 bg-white rounded-lg shadow-md">
      ...
      <div className="flex gap-2 items-center">
        {increment > 0 ? (
          <>
            <div className="flex gap-1 items-center border border-green-500 rounded-lg px-2">
              <h3 className="text-sm font-semibold">{increment}</h3>
              <ArrowUpRight className="text-green-500 w-4 h-4" />
            </div>
            <span className="text-sm ">increase from yesterday</span>
          </>
        ) : (
          <>
            ...
            <span className="text-sm">decrease from yesterday</span>
          </>
        )}
      </div>
    </div>
